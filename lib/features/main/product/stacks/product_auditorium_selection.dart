...
import '../../../../common/services/cinema_service.dart';
...
class ProductAuditoriumSelection extends StatefulWidget {
  const ProductAuditoriumSelection({super.key});

  @override
  State<ProductAuditoriumSelection> createState() =>
      _ProductAuditoriumSelectionState();
}

class _ProductAuditoriumSelectionState
    extends State<ProductAuditoriumSelection> {
